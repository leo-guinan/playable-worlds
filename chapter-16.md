...
## What Satoshi Made Possible

Bitcoin proved one thing that could not be unproved:

Global coordination without central authority is possible.

A 19-year-old in Toronto read that proof and asked the next question.

Satoshi built a game that maintained a ledger.
Vitalik Buterin asked: what if the game could run other games?

Ethereum, launched in 2015, did not improve on Bitcoin's coordination mechanism.
It extended it.

Bitcoin's game had one set of rules: maintain the ledger, validate the chain, reward the miners.

Ethereum made the rules programmable.

Any game whose rules could be written as code could now run on the same coordination infrastructure.

The contract enforces itself.
The game runs without a referee.
The outcome is verifiable by anyone.

This is the Euler move, applied to Satoshi.

Euler took Fermat's insights and built arenas where others could play.
Buterin took Satoshi's infrastructure and built a platform where others could design games.

The lineage is consistent.

Every generation in this story either discovers something, builds the arena, or expands who can enter.

Satoshi discovered that autonomous agreement was possible.
Buterin made it programmable.

What comes next is not another individual insight.

It is the question of which games, now that they can be built, should be.
...
And now they can spawn other games.
